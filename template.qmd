...
ggplot(seeds_df,aes(x=l_k,y=w_k)) +
  geom_point()

ggplot(seeds_df,aes(x=a,y=l_g)) +
  geom_point()

seeds_df_num <- seeds_df |>
...
```{r}
#| fig-cap: We would select 3 groups to indicate a kmeans cluster because the kink in the graph is most pronounced at 3 clusters
...
2. remove/handle NAs (note: none in this case)

3. select only numeric columns

4. scale the data

5. get the distnace of the scaled data
